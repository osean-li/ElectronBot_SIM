# Phase 8：Sim2Real 真机部署

> **目标**：将在仿真中训练/调试的 AI 策略部署到真机 ESP32 (release v2.2.6) 上。
>
> **⚠️ 关键设计决策**: release v2.2.6 真机是 WebSocket **客户端**（连接云端后台），不是 Server。**真机没有 `ws://IP:8080/ws` 端点**。
> 所有真机通信必须通过**小智云端 API 透传**。
>
> **前置依赖**：Phase 3-7 完成 | **硬件**：ESP32-S3 真机 (已刷 release v2.2.6 固件)
>
> **输出**：Sim2Real 云端部署脚本 + WebSocket 直连部署 (OTA 后可用) + 校准工具
>
> **文档版本**: v1.1  
> **最后更新**: 2026-07-04  
> **变更类型**: 补充软件工程规范章节
...
| **C: WebSocket 直连** | ws://IP:8080/ws | <10ms | 实时关节控制 | ❌ (需OTA) |
